...
class UserManager(IntegerIDMixin, BaseUserManager[Userlist, int]):
    reset_password_token_secret = SECRET
    verification_token_secret = SECRET

    async def on_after_register(self, user: Userlist, request: Optional[Request] = None):
    ...
    async def create(
        ...
        # "password" меняется на "hashed_password"
